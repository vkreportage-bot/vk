    ...
    <article className="pb-24 md:pb-32">
      ...
      <header className="container-vk pb-10 pt-24 md:pb-14 md:pt-32">
        ...
        <div className="mt-10 max-w-3xl">
          <p className="text-xl leading-8 tracking-[-0.02em] text-black/65 md:text-2xl md:leading-9">
            {article.excerpt}
          </p>

          {/* DATE + TEMPS DE LECTURE */}
          <div className="mt-6 flex items-center gap-5 text-sm text-black/45">
      ...
      {article.coverUrl ? (
        <div className="container-vk">
          ...
          {article.coverAlt ? (
            <p className="mt-3 max-w-2xl text-xs leading-5 text-black/40">
              {article.coverAlt}
            </p>
          ) : null}
        </div>
      ...
      <footer className="container-vk mt-20 md:mt-28">
        <div className="grid gap-8 border-t border-black/15 pt-10 md:grid-cols-12 md:items-end">
          ...
          <div className="flex flex-wrap gap-3 md:col-span-4 md:col-start-9 md:justify-end">
            <Link
              href="/projects"
              className="inline-flex min-h-11 items-center gap-2 rounded-full border border-black/20 px-5 text-sm font-medium transition hover:bg-black hover:text-white"
            >
              Voir les projets
            ...
            <Link
              href="/contact"
              className="inline-flex min-h-11 items-center gap-2 rounded-full bg-black px-5 text-sm font-medium text-white transition hover:bg-black/80"
            >
              Parler d’un projet
            </Link>
          </div>
